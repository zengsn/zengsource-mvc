 ...
 * @since 6.0
 */
public class InletFilter implements Filter {
	...
	public void init(FilterConfig cfg) throws ServletException {
		this.springContextHelper = new WebAppContextHelper(cfg.getServletContext());
		String actionEditorName = cfg.getInitParameter(ACTION_EDITOR);
		this.actionEditorName = actionEditorName == null ? "default" : actionEditorName;
	}
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chn)
		...
		try {
			mvcContext.getPluginFactory().enableAll();
